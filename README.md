# Ayatana System Indicator &mdash; Accessibility [![Build Status](https://api.travis-ci.com/AyatanaIndicators/ayatana-indicator-a11y.svg)](https://travis-ci.com/github/AyatanaIndicators/ayatana-indicator-a11y)
